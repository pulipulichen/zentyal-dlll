package EBox::dlllciasrouter::Model::OtherDomainNames2;
...
sub _table
{
    ...
    my $dataTable =
    {
        'tableName' => 'OtherDomainNames2',
        'printableTableName' => __('Other Domain Names'),
        'printableRowName' => __('Other Domain Names'),
        'pageTitle' => $self->pageTitle(),
        'modelDomain' => 'dlllciasrouter',
        'automaticRemove' => 1,
        'defaultController' => '/dlllciasrouter/Controller/OtherDomainNames2',
...
sub addedRowNotify
{
    ...
    $subRow->store();
        ...
        $self->getLibrary()->show_exceptions( $_ . '; Please add domain name again. (OtherDomainNames2->addedRowNotify)');
    };
...
sub deletedRowNotify
{
    ...
    $row->store();
        ...
        $self->getLibrary()->show_exceptions($_ . '(OtherDomainNames2->deletedRowNotify())');
    };
}
