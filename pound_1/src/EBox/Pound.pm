...
#    );
    ...
    my $folder = new EBox::Menu::Folder('name' => 'Virtual_router',
                                        'text' => $self->printableName(),
                                        #'separator' => 'Virtual Router',
                                        'order' => 0);

    $folder->add(new EBox::Menu::Item('url' => 'Virtual_router/View/Settings',
                                      'text' => __('Settings')));
    $folder->add(new EBox::Menu::Item('url' => 'Virtual_router/View/PoundServices',
                                      'text' => __('Back End')));
    $folder->add(new EBox::Menu::Item('url' => 'Virtual_router/View/URLRedirect',
                                      'text' => __('URL Redirect')));
    $folder->add(new EBox::Menu::Item('url' => 'Virtual_router/View/DNS',
                                      'text' => __('DNS')));
