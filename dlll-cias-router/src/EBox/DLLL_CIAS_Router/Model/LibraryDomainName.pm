package EBox::DLLL_CIAS_Router::Model::LibraryDomainName;
...
sub deleteDomainName
{
    ...
    if ($hasDomainName == 0 && $excludeModel ne 'DLLL_CIAS_RouterServices') 
    {
        $hasDomainName = $self->modelHasDomainName('DLLL_CIAS_RouterServices', $domainName);
    }
