...
#        url => 'DLLL_CIAS_Router/Composite/Global',
...
#    );
    ...
    $folder->add(new EBox::Menu::Item('url' => 'DLLL_CIAS_Router/View/Settings',
                                      'text' => __('Settings')));
    $folder->add(new EBox::Menu::Item('url' => 'DLLL_CIAS_Router/View/DLLL_CIAS_RouterServices',
                                      'text' => __('Back End')));
    ...
    # 不要Port Forwarding了，留給DLLL_CIAS_Router去設定就好                                  
    #$folder->add(new EBox::Menu::Item('url' => 'DLLL_CIAS_Router/View/PortForwarding',
...
sub _setConf
{
    ...
    my $services = $self->model('DLLL_CIAS_RouterServices');
...
{
    my ($self) = @_;
    return $self->model("DLLL_CIAS_RouterLibrary");
}
