package EBox::DLLL_CIAS_Router::Model::DLLL_CIAS_RouterServices;
...
sub _table
{
    ...
    my $dataTable =
    {
        tableName => 'DLLL_CIAS_RouterServices',
        ...
        #sortedBy => 'updateDate',
        'HTTPUrlView'=> 'DLLL_CIAS_Router/View/DLLL_CIAS_RouterServices',
...
sub deletedRowNotify
{
    ...
    my $libREDIR = $self->loadLibrary('LibraryRedirect');
    my $libDN = $self->loadLibrary('LibraryDomainName');
    $libDN->deleteDomainName($row, 'DLLL_CIAS_RouterServices');
